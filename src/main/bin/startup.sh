...
MAIN_CLASS="com.github.johnsonmoon.java.ftp.server.Main"
JAVA_OPTS="-Dapp.name=${APP_NAME} -Dwork.home=${WORK_HOME}"
JAVA_OPTS="${JAVA_OPTS} -Dspring.servlet.multipart.enabled=true"
JAVA_OPTS="${JAVA_OPTS} -Dspring.servlet.multipart.max-file-size=10240MB"
JAVA_OPTS="${JAVA_OPTS} -Dspring.servlet.multipart.max-request-size=10240MB"
